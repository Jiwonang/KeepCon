...
작성일: 2026-07-06 · 최종 갱신: 2026-08-30 · 계약 버전: **v3.11** (인라인 에러 배너 승격 — `lib/shared/widgets/`)
...
| `ShareRepository.requestToJoin(credential)` → `Future<JoinRequest>` — `credential`은 **링크 토큰 또는 6자리 초대코드**(모양으로 구분). 만료는 **사용한 자격증명 기준** | method | 〃 | 3.9 |
| `InviteExpiredException extends StateError` — 만료만 구별해 잡는 하위 타입(화면이 "만료된 초대코드"를 말할 근거) | class | `lib/shared/repositories/share_repository.dart` | 3.9 |
