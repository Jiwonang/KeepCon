...
///
/// 값은 정본 팔레트의 [AppColorsLight.radius](=18)와 정합한다. 개별 뱃지(9·10)나
/// 소스 아이콘 타일(15)·이모지 타일(16)처럼 한 곳에서만 쓰는 반경은 승격하지 않고
/// 호출부에 남긴다('늦게 승격' — 실제 2번째 소비자가 있는 값만 토큰화).
abstract final class AppRadii {
  /// 카드·배너 컨테이너 반경(정본 18). 홈 리치 카드·스캔 소스 카드·공유 그룹/공유 카드 공통.
