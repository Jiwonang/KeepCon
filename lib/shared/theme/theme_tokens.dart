...
abstract final class AppRadii {
  ...
  /// 그룹 상세의 아이콘+라벨 액션 타일(초대·나가기 등).
  ///
  /// ⚠️ 한때 "만료 선택 버튼"도 이 값을 썼다고 적혀 있었으나 **그 UI는 삭제됐다** —
  /// 초대 만료를 고르던 버튼은 만료 정책을 24시간으로 못박으면서 사라졌다(2026-08-11).
  /// 그 서술 때문에 "만료" 관련 버튼이면 이 토큰이라고 읽히기 쉬운데(리뷰에서 실제로
  /// 그렇게 지목됐다), **상세 화면 하단의 주 액션 버튼은 [tile]이다** — 개인·공유 상세의
  /// 사용 완료·기간 연장 버튼이 모두 그렇고, 그 값은 목업에서 온 것이라 바꾸면 기존
  /// 버튼의 렌더링이 함께 움직인다.
