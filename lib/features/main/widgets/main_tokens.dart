/// main 페이지 — 공유 색 토큰 접근 헬퍼.
///
/// `ColorScheme`에 직접 매핑되지 않는 정본 토큰(예: darkSurface = 알림 배너/아바타/
/// D-day 강조면)을 **밝기에 맞는 공유 팔레트**에서 가져온다. 색을 하드코딩하지 않고
...
extension MainThemeTokens on BuildContext {
