...
///   긴 어절을 줄 폭에 맞춰 강제로 끊는다. 남는 제약은 끊기는 **자리**다: `/`·`-`
///   같은 자연스러운 지점이 아니라 임의 위치에서 갈라지므로, 긴 URL·식별자에는
///   걸어도 얻는 것이 없다(해가 되지도 않는다). 재어서 못박아 두었으니
///   (`keep_all_ko_test.dart`) 이 문장을 고칠 때는 그 테스트를 먼저 보라.
