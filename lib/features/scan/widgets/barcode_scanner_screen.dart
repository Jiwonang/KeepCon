...
///
/// **왜 16:10이 아니라 4:3인가.** 여백 버그를 고치기 전까지 화면에 실제로 그려지던
/// 사각형이 이 근처였고(폭 411에서 약 1.35, 폭 360에서 약 1.32), 그 모양이 낫다고
/// 판단해 그대로 유지한 것이다. 당시에는 **화면 폭마다 비율이 달라지는** 상태였고
/// (좁을수록 세로로 길쭉해졌다) 그게 고친 결함이다 — 지금은 어느 화면에서든 4:3으로
/// 같다. 16:10으로 되돌리면 프레임이 눈에 띄게 납작해진다.
