...
// - isWellFormedInviteCode: **첫 조회 대상**을 고르는 힌트다 — 판정이 아니다.
//   v3.0 이전 링크 토큰은 6자리 숫자라 이 검사를 통과한다(아래 레거시 케이스).
//   "이것이 코드였는가"의 정본은 저장소의 폴백 조회 결과(`InviteExpiredException.isCode`)다.
//
