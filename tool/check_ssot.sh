...
SSOT_PROVIDERS="notificationsProvider|notificationsReadAtProvider|unreadNotificationCountProvider|authRepositoryProvider|gifticonRepositoryProvider|shareRepositoryProvider|themeModeProvider|myGroupsProvider|myGroupsRetryProvider|sessionUserProvider|errorReporterProvider|inviteOriginProvider"
...
# 재분기하면 알림까지 어긋난다.
SSOT_FUNCTIONS="retryNotifications|retrySessionIfFailed|retryMyGroups|foldSessionUser|daysUntilExpiry|isExpiringSoon|isExpiredByDate|inviteUrlFrom|inviteOriginFor|parseInviteToken|isSharableOrigin"
